...
<div class="container">   
 ...
 <div id="myCarousel" class="carousel slide" data-ride="carousel">  
    ...
    <div class="carousel-inner" role="listbox">  
      ...
      <img src="bfm/first.jpg" width="200" height="200" alt="first" >  
        
      </div>  
  
      <div class="item">  
        <img src="bfm/second.jpg" width="200" height="200" alt="second" >  
      </div>  
      
      <div class="item">  
        <img src="bfm/third.jpg" width="200" height="200"  alt="third" >  
      </div>  
      
      <div class="item">  
        <img src="bfm/fourth.jpg" width="200" height="200" alt="fourth" >   
      </div>
      
      <div class="item">  
        <img src="bfm/fifth.jpg" width="200" height="200" alt="fifth" >  
      </div>
      
      
       <div class="item">  
        <img src="bfm/sixth.jpg" width="200" height="200" alt="sixth" >  
      </div>  
  
      <div class="item">  
        <img src="bfm/seventh.jpg" width="200" height="200"  alt="seventh" >  
      </div>  
      
      <div class="item">  
        <img src="bfm/eight.jpg" width="200" height="200"  alt="eight" >  
      </div>  
      
      <div class="item">  
        <img src="bfm/ninth.jpg" width="200" height="200"  alt="ninth" >   
      </div>
      
      <div class="item">  
        <img src="bfm/tenth.jpg" width="200" height="200"  alt="tenth" >  
      </div>
    </div>  
...
<table>
<tr>
<td><a href="#"><img src="bfmitems/first.jpg"  width="200" height="200" alt="first" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><a href="#"><img src="bfmitems/second.jpg"  width="200" height="200" alt="second" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><a href="#"><img src="bfmitems/third.jpg"  width="200" height="200" alt="third" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><a href="#"><img src="bfmitems/fourth.jpg"  width="200" height="200" alt="fourth" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><a href="#"><img src="bfmitems/fifth.jpg"  width="200" height="200" alt="fifth" ></a></td>
</tr>
</table>
...
<table>
<tr>
<td><a href="#"><img src="bfmitems/sixth.jpg"  width="200" height="200" alt="first" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><a href="#"><img src="bfmitems/seventh.jpg"  width="200" height="200" alt="second" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><a href="#"><img src="bfmitems/eight.jpg"  width="200" height="200" alt="third" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><a href="#"><img src="bfmitems/ninth.jpg"  width="200" height="200" alt="fourth" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><a href="#"><img src="bfmitems/tenth.jpg"  width="200" height="200" alt="tenth" ></a></td>
</tr>
</table>
...
<table>
<tr>
<td><a href="#"><img src="bfmitems/eleventh.jpg"  width="200" height="200" alt="elevnth" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><a href="#"><img src="bfmitems/twelth.jpg""  width="200" height="200" alt="twelth" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><a href="#"><img src="bfmitems/thirteen.jpg""  width="200" height="200" alt="thirteen" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><a href="#"><img src="bfmitems/fourteen.jpg""  width="200" height="200" alt="fourten" ></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><a href="#"><img src="bfmitems/fifteen.jpg""  width="200" height="200" alt="fiften" ></a></td>
</tr>
</table>
<br><br><br><br>
...
<p align="left">The BFC was founded in 2006 under the chairmanship of Martin Jourdan. It brought together an alliance of trade associations and unions to speak with a single voice to government. The BFC’s founder members included the British Contract Furnishers Association/ Office Furniture Manufacturers Association (BCFA/OFFMA), British Furniture Manufacturers (BFM), ProSkills, the Furniture Industry Research Association (FIRA), the National Bed Federation (NBF), the Worshipful Company of Furniture Makers (WCFM), the Association of Master Upholsterers & Soft Furnishers (AMUSF), and the General & Municipal Boilermakers Union.After restructuring in the summer of 2008 its slimmed down Executive Board became responsible for the daily decision making of the group. The Board now consists of Chairman Martin Jourdan, Jessica Alexander (NBF), Roger Mason (BFM), Hayden Davies (FIRA) and Peter Smith (BCFA). The BFC’s Company Secretary is Pete Beele (FIRA).The Executive meets in London every two months to discuss issues of concern facing the industry. Along with consultants from public affairs firm PoliticsDirect they plan the BFC’s response to government announcements, initiatives and legislation, as well as general political issues affecting the industry.
