...
PreparedStatement ps=con.prepareStatement("insert into emailcomment(comment1,email) values(?,?)");  
ps.setString(1,comment);  
ps.setString(2,email);  
int i=ps.executeUpdate();  
  
PreparedStatement ps2=con.prepareStatement("select * from emailcomment order by id desc");  
