...
<div id="header">
	<div id="navigation">
    	<ul>
        	<li><a href="pindex.jsp">Home</a></li>
            <li><a href="pabout.jsp">About Us</a></li>
            <li><a href="padmin.jsp">ADMINISTRATOR </a></li>
            <li><a href="pcustomer.jsp">CUST0MER</a></li>
...
<table width="300" border="0" cellspacing="10" cellpadding="0" align="center"><%
	    ...
	    boolean status=pverifyLogin1.checkLogin(username,password);
...
<div id="footer">
  <div id="footer_1">
   		<ul>
            ...
            <li><a href="#"></a>ADMINISTRATOR</li>
            <li><a href="#"></a>CUST0MER</li>
