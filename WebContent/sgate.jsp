...
<div class="container">   
 ...
 <div id="myCarousel" class="carousel slide" data-ride="carousel">  
    ...
    <div class="carousel-inner" role="listbox">  
      ...
      <img src="compacc/first.JPG" width="200" height="200" alt="fourth" >  
        
      </div>  
  
      <div class="item">  
        <img src="compacc/second.JPG" width="200" height="200" alt="fifth" >  
      </div>  
      
      <div class="item">  
        <img src="compacc/third.JPG" width="200" height="200"  alt="sixth" >  
      </div>  
      
      <div class="item">  
        <img src="compacc/fourth.JPG" width="200" height="200" alt="seventh" >   
      </div>
...
<tr><td><img src="payitems/sgate.JPG"  alt="h15"></td>
<td><b>Seagate Backup Plus Slim 1 TB Wired External </b><br>
<b>Hard Disk Drive with 200 GB Cloud Storage</b><br>
(Black, Mobile Backup Enabled)<br>
1 TB Capacity<br>
USB 3.0 Desktop Drive<br>
Cloud Back-up<br>
USB 2.0 Supported<br>
WARRANTY<br>
...
<input type="hidden" name="hosted_button_id" value="A5CW3VG4NGEM6">
...
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="KBQJSPA59D2PJ">
