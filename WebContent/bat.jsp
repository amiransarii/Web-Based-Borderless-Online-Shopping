...
<tr><td><img src="payitems/bat.JPG"  alt="bat"></td>
<td><b>Sportson Twenty Twenty Tennis Kashmir </b><br>
<b>Willow Cricket Bat </b><br>
(Short Handle, 1000 g)<br>
Playing Level: Advanced, Training, Recreational, Intermediate, Beginner<br>
Age Group: 10 Years & Above<br>
Ideal for: Men, Boys, Girls, Women, Junior, Senior<br>

50 MYR <br><br>

<form target="paypal" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="V9A9X3LWTWUPC">
...
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="6HQE7DTFMBJRY">
