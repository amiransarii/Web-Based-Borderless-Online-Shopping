...
<form action="empval" method="post">
<center><br><br>
<b><font color= green size=5> EMPLOYEE ACCOUNT </font><br><br></center>
<table>
<tr><td><font color="black"><mark>Enter id</mark></font></td><td><input type="text"   name="id" required placeholder="Enter  valid id"></td></tr>
<tr><td><font color="black"><mark>Enter Name</mark></font></td><td><input type="text" name="name"  required placeholder="Enter Full Name"></td></tr>
<tr><td><input type="submit" value= "Member Login"></td></tr>
</table>
</form>
