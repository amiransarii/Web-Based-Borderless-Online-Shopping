...
<tr><td><img src="payitems/mipad.JPG"  alt="mipad"></td>
<td>Mi Pad(White)<br>
7.9 inch 2048x1536 Screen<<br>
Expandable upto 128 GB<br>
2.2 GHz NVIDIA Tegra K1<br>
8 MP Camera<br>
2 GB RAM<br>
WARRANTY<br>
1 Year manufacturer warranty for the Tablet, 6 months<br>
manufacturer warranty for other inbox accessories<br><br>
800 MYR <br><br>
...
<input type="hidden" name="hosted_button_id" value="VW3GG9RXM5VD4">
