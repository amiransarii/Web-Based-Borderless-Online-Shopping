...
<form action="talentsignup" method="post">
<center><br><br>
<b><font color= green size=5> New Registration</font><br></center>
<table>
<tr><td><font color="black"><mark>Full Name</mark></font></td><td><input type="text"   name="tusername" required placeholder="Enter  full Name"></td></tr>
<tr><td><font color="black"><mark>Address</mark></font></td><td><input type="text" name="tuseraddress"  required placeholder="Enter Address"></td></tr>
<tr><td><font color="black"><mark>Mobile Number</mark></font></td><td><input type="text" name="tusermobilenumber"  required placeholder="Enter Mobile Number"></td></tr>
...
<tr><td><input type="submit" value= "Register"></td><td><a href="talentaccount.jsp"> Login</a></td></tr>
</table>
</form>
