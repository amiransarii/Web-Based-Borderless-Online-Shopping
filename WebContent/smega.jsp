...
<div class="container">   
 ...
 <div id="myCarousel" class="carousel slide" data-ride="carousel">  
    ...
    <div class="carousel-inner" role="listbox">  
      ...
      <img src="kbf/first.JPG" width="200" height="200" alt="fourth" >  
        
      </div>  
  
      <div class="item">  
        <img src="kbf/second.JPG" width="200" height="200" alt="fifth" >  
      </div>  
      
      <div class="item">  
        <img src="kbf/third.JPG" width="200" height="200"  alt="sixth" >  
      </div>  
      
      <div class="item">  
        <img src="kbf/fourth.JPG" width="200" height="200" alt="seventh" >   
      </div>
      
      <div class="item">  
        <img src="kbf/fifth.JPG" width="200" height="200" alt="eight" >  
      </div> 
...
<tr><td><img src="payitems/smeaga.JPG"  alt="smega"></td>
<td><b>Skechers MEGA BLADE 2.0 Sneakers</b><br>
Material: Leather, Mesh<br>
Occasion: Casual<br>
150 MYR <br><br>

<form target="paypal" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="HNUA338NWHNVW">
...
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="5JUDTMEU7NRS2">
