...
<tr><td><img src="payitems/h15.JPG"  alt="h15"></td>
<td><b>HP 15-ac123tx Core i5 (5th Gen) - (4 GB/1 TB</b><br>
<b>HDD/Windows 10/2 GB Graphics) Notebook</b> <br>
<b>N8M28PA</b><br>
(15.6 inch, Turbo SIlver, 2.19 kg)<br>
<ul>
AMD Radeon R5� GPU<br>
DTS Studio Sound<br>
Windows 10 OS<br>
island-style keyboard<br>
WARRANTY<br>
1 Year<br><br>
...
<input type="hidden" name="hosted_button_id" value="KAQ35AJXB8D88">
...
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="9JNSWJXXRH6XL">
