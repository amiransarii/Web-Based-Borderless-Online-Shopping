...
if ( username == "softinfo@web.com" && password == "softech12"){
alert ("Login successfully");
window.location ="insertrecord.jsp"; // Redirecting to other page.
return true;
}
else{
...
<form id= "form_id" method="post" name="myform">
 <table><br><br><br>
<font color=blue size=5>ADMINSTRATOR ACCOUNT</font><br>
<tr><td><mark><font size=5>Email Id</font></mark></td><td><input type="text" name="aid" id="aid"/></td></tr>
<tr><td><mark><font size=5>password</font></mark></td><td><input type="password" name="pass" id="pass"/></td></tr>
<tr><td><input type="button" value="Login" id="submit" onclick="aidval()"/></td></tr>
 </table>     
 </form>
