					...
					%>
							...
							<% if(request.getAttribute("reg")!=null){
								...
								%>
									...
									<form id="form1" method="post" action="sloginprocess.jsp">
										<fieldset>
										<table>
					   ...
					   <tr><td>  Password:</td></tr><tr><td><input id="text2" type="password" name="userpass" /></td></tr>
						<tr><td><input type="submit" id="login-submit" value="Login"/></td></tr>
											...
											<div class="foot_pad">
							<ul class="ls">
								<li><a href="sregister.jsp">New User</a></li><br>
							<li><a href="forgot.jsp">Forgot Password</a></li><br>	
							<li><a href="sadmin.jsp">Administrator Login</a></li><br>
							</ul></div>
										</fieldset>
									</form>
								</div>
