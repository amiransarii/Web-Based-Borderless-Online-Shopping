...
<div class="container">   
 ...
 <div id="myCarousel" class="carousel slide" data-ride="carousel">  
    ...
    <div class="carousel-inner" role="listbox">  
      ...
      <img src="kbc/first.JPG" width="200" height="200" alt="fourth" >  
        
      </div>  
  
      <div class="item">  
        <img src="kbc/second.JPG" width="200" height="200" alt="fifth" >  
      </div>  
      
      <div class="item">  
        <img src="kbc/third.JPG" width="200" height="200"  alt="sixth" >  
      </div>  
      
      <div class="item">  
        <img src="kbc/fourth.JPG" width="200" height="200" alt="seventh" >   
      </div>
...
<tr><td><img src="payitems/kbc.JPG"  alt="h15"></td>
<td>Suitable For: Western Wear<br>
...
<input type="hidden" name="hosted_button_id" value="RDN59JPLWDE78">
...
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="4LYDRXN2379BS">
