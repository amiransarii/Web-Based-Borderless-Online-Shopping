...
<center><br><br>
<b><font color= green size=5> Customer Account </font><br></center>
<table>
<tr><td><font color="black"><mark>Full Name</mark></font></td><td><input type="text"   name="username" required placeholder="Enter  full Name"></td></tr>
<tr><td><font color="black"><mark>Address</mark></font></td><td><input type="text" name="useraddress"  required placeholder="Enter Address"></td></tr>
<tr><td><font color="black"><mark>Pin Code</mark></font></td><td><input type="text" name="userpincode"  required placeholder="Enter Pin Code"></td></tr>
<tr><td><font color="black"><mark>Contact Number</mark></font></td><td><input type="text" name="usercontact"  required placeholder="Enter contact Number"></td></tr>
<tr><td><font color="black"><mark>Email</mark></font></td><td><input type="text" name="useremail"  required placeholder="Enter Email Id"></td></tr>
<tr><td><font color="black"><mark>Password</mark></font></td><td><input type="password" name="userpass"  required placeholder="Enter Password"></td></tr>

<tr><td><input type="submit" value= "Register"></td><td><a href="userlogin.jsp"> Login</a></td></tr>
</table>
</form>
