...
var request;
function qget1(){
window.location='qget1.jsp';
}
function qget(){
var v=document.getElementsByName('radio').value;
window.location="qget.jsp?ans="+v;
}
function sendInfo()
{
var v=document.myform.subject.value;
var url="qfindname2.jsp?val="+v;
             ...
             <% 
            	...
            	<div class="calendar_box2">
                	...
                	<div class="calendar_box_content">
                		...
                		<form method="post" action="qget1.jsp">
					<table><tr><td>
					<% 
