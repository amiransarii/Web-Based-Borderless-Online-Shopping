...
<table width="300" height="100" border="0" cellspacing="10" cellpadding="0" align="center"><%
		...
		if(status==true){
		    ...
		    //out.print("<table>");
			out.println("<br><br><a href='lnewstaff.jsp'> Create new staff </a><br>");
			out.println("<br><a href='lshowstaff.jsp'> Show staff deatils </a><br>");
			 out.println("<br><a href='lbooksdetails.jsp'> Show Book deatils </a><br>"); 
		   ...
		   // out.print("</table>");
			...
			%>
			<jsp:forward page="ladmin.jsp"></jsp:forward> 
			<% 
			}
