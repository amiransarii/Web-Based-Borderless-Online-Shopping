...
<A href="lindex.jsp"> <IMG SRC="images/lib1.jpg"></IMG></A>
</head>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
  ...
  <table width="100%"  border="0" cellspacing="7" cellpadding="0">
        <tr>
          <td><div align="center"><span class="bottombar"><strong>&copy; OUR-LIBRARY, @Borderless Shopping </strong></span></div></td>
        </tr>
        <tr> 
          <td>
