...
<tr >
    ...
    <td width="1200" valign="top">
    	<div id="welcome" style="border-right:#666666 1px dotted;"><h1><font color=blue>BALANCE FORM</font></h1><br>
    ...
    <td width="299" valign="top">
    	<div id="welcome" style="border-right:#666666 1px dotted;"><h1><font color=orange>Balance</font></h1><br>
    	    <center><img src="images/money.jpg" alt="business" width="196" height="106"></center><br>
    	      <p>This is a page where users can check their balance  which can be used during the purchasing the products </p>
