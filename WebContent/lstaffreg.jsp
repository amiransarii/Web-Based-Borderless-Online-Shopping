...
<table width="300" border="0" cellspacing="10" cellpadding="0" align="center"><%
       ...
       String repassword=request.getParameter("repassword");
	    ...
	    int status=lRegisterUser1.register1(username,password,repassword,phone,adderess,syd);
		...
		if(status>0){
			...
			%>
			<jsp:forward page="lnewstaff.jsp"></jsp:forward> 
			<% 
			}
		//}
		else{
			...
			%>
			<jsp:forward page="ladmin1.jsp"></jsp:forward> 
			<%
		}
