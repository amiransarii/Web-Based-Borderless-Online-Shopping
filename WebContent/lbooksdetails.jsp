...
<table height="380"><%
      	...
      	try {
			...
			out.print("<td><a href='ldeletebookdetails.jsp'>Delete</a></td>");	
			out.print("<td><a href='lupdatebookdetails.jsp'>update</a></td>");	
			...
			%>			
			<jsp:forward page="lordersadmin.jsp"></jsp:forward> 
			<% 
