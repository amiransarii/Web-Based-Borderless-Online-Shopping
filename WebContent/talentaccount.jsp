...
<form action="talentsignin" method="post">
<center><br><br>
<b><font color= green size=5> Talent Account </font><br><br></center>
<table>
<tr><td><font color="black"><mark>Enter Emailid</mark></font></td><td><input type="text"   name="tuseremail" required placeholder="Enter  EmailId"></td></tr>
<tr><td><font color="black"><mark>Enter Password</mark></font></td><td><input type="password" name="tuserpass"  required placeholder="Enter Passowrd"></td></tr>
<tr><td><input type="submit" value="Login"></td><td><input type="reset"></td></tr>
<tr><td><a href="talentreg.jsp"> New Registration</a></td></tr>
</table>
</form>
