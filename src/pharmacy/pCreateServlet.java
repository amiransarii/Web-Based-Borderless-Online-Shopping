...
public class pCreateServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
	    ...
	    int status=pRegisterUser.register(username, password, repassword,disname, adderess,cityname,statename,country,region,phone,email);
	   
	    
		if(status>0){
				
			request.setAttribute("welcome","WELCOME! YOU HAVE BEEN REGISTERD");
			RequestDispatcher rd=request.getRequestDispatcher("pcustomer.jsp");
