...
public class innovativeproducts extends HttpServlet {
		...
		InetAddress ip = InetAddress.getLocalHost();
			 ...
			 for(FileItem item:items)
				{ System.out.println("okok3") ;
					...
					File tosave=new File(getServletContext().getRealPath("/innovative/products/"),cfile.getName());
					item.write(tosave);
					
					dbPath="innovative/products/"+cfile.getName();
					}
			...
			String sql="insert into innovativeprod values('"+n+"','"+a+"','"+d+"','"+g+"','"+h1+"','"+c+"','"+em+"','"+dbPath+"','"+ip.getHostAddress()+"')";// Local Host ip
	        ...
	        out.println("<a href=filedownload.jsp>Download File </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
