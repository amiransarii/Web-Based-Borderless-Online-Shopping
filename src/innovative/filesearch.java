...
public class filesearch extends HttpServlet{
    ...
    try{
        ...
        ResultSet rs1 = st1.executeQuery("select * from innovativeprod where NAME LIKE '" + "%"+ se1 + "%" +"'");
        out.println("<br>");
        out.println("<form action=filesearch method=get>");
        ...
        out.println("Search File<input type=text name=se1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
